...
require_once 'dbConnection.php';
  ...
  switch($httpMethod) {
    ...
    case 'POST':
      ...
      // First, validate email_address and password
      // On second thought, let you figure out email_address validation and do password confirmation
      ...
      // Get Data from DB
        ...
        $sql = "INSERT INTO user (email_address, password) " .
               "VALUES (:email_address, :hashedPassword) ";
